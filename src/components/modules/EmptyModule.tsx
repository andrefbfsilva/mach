...
export function EmptyModule({ onAddClick }: EmptyModuleProps) {
  return (
    <button
      onClick={onAddClick}
      className="module-panel rounded-lg h-full w-full flex flex-col items-center justify-center gap-4 border-2 border-dashed border-primary/30 hover:border-primary/60 hover:bg-primary/5 transition-all cursor-pointer group cockpit-press"
    >
